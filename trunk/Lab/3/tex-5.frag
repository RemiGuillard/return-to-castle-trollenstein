...
void main(void)
{
  ...
  vec4 myTex1 = texture(texUnit1, oTex.st);
  vec4 myTex2 = texture(texUnit2, oTex.st);
  out_Color = ((sin(fragPos.x*5.0) * myTex1) + (1.0 - sin(fragPos.x*5.0) ) * myTex2) * vec4(intensity, 1.0) ;
